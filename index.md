...
1. GenericAPIServer skeleton (pkg/virt-api/apiserver) [PR #18607](https://github.com/kubevirt/kubevirt/pull/18607)
    
    Ref: inspired by virt-template / sample-apiserver [virt-template](https://github.com/kubevirt/virt-template)
...
2. Endpoint migration [PR #18607](https://github.com/kubevirt/kubevirt/pull/18607)
...
3. Cleanup and package layout [PR #18607](https://github.com/kubevirt/kubevirt/pull/18607)
...
4. Authn/authz tests (follow-up PR: [PR #18823](https://github.com/kubevirt/kubevirt/pull/18823))
    ...
    I also evaluated lyarwood’s envtest controller harness (#18726): [envtest controller harness (#18726)](https://github.com/kubevirt/kubevirt/pull/18726
